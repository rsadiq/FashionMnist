...
'''
This is a realtime implementation of Fashion Object detection
requirements:
        python3.6
...
ap.add_argument("-o", "--out_video", default= 'outvideo',
	help="path to output video file")
args = vars(ap.parse_args())

# Load Model
model = models.load_model('BN_model1.h5')
